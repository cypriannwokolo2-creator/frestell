...
export function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 px-5 py-2.5 text-sm font-medium
        border border-[var(--border)] bg-transparent text-[var(--text-primary)]
        hover:bg-[var(--hover-overlay)] transition-all duration-150 radius-brutal
